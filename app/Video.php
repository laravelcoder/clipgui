...
class Video extends Model
{
    ...
    protected $fillable = ['title', 'original_name', 'disk', 'path', 'description', 'clip_upload', 'notes', 'converted_for_downloading_at', 'converted_for_streaming_at', 'industry_id', 'brand_id', 'states_id', 'products_id'];
    protected $hidden = [];
    ...
    {
        return $this->belongsToMany(Image::class, 'image_video')->withTrashed();
    }
