        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('global.videos.fields.title').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('original_name', trans('global.videos.fields.original-name').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('disk', trans('global.videos.fields.disk').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('path', trans('global.videos.fields.path').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('description', trans('global.videos.fields.description').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('clip_upload', trans('global.videos.fields.clip-upload').'', ['class' => 'control-label']) !!}
                    {!! Form::hidden('clip_upload', old('clip_upload')) !!}
                    @if ($video->clip_upload)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $video->clip_upload) }}" target="_blank">Download file</a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('industry_id', trans('global.videos.fields.industry').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('brand_id', trans('global.videos.fields.brand').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('states_id', trans('global.videos.fields.states').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('products_id', trans('global.videos.fields.products').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('notes', trans('global.videos.fields.notes').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('images', trans('global.videos.fields.images').'', ['class' => 'control-label']) !!}
                    ...
                    {!! Form::select('images[]', $images, old('images') ? old('images') : $video->images->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-images' ]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('converted_for_downloading_at', trans('global.videos.fields.converted-for-downloading-at').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('converted_for_streaming_at', trans('global.videos.fields.converted-for-streaming-at').'', ['class' => 'control-label']) !!}
